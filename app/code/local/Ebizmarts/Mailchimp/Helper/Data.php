...
class Ebizmarts_Mailchimp_Helper_Data extends Mage_Core_Helper_Abstract{
	...
	private function doTheAction($subscriber){
		...
		if($member){
			...
			}elseif((!$subscriber->getSubscriberStatus()) OR ($subscriber->getSubscriberStatus() && $subscriber->getSubscriberStatus() == Mage_Newsletter_Model_Subscriber::STATUS_NOT_ACTIVE)){
